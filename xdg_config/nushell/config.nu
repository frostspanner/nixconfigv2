...
$env.FZF_DEFAULT_OPTS = "--color=fg:#ebfafa,bg:#212337,hl:#37f499,fg+:#ebfafa,bg+:#5b5c66,hl+:#37f499,info:#f7c67f,prompt:#04d1f9,pointer:#7081d0,marker:#7081d0,spinner:#f7c67f,header:#323449"
